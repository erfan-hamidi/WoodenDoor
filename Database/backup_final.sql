...
CREATE ROLE admin;
ALTER ROLE admin WITH NOSUPERUSER NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:WsvwN6G3dPZPO+GXuEoFEA==$X0FONNEo00YbEGg5MLUOA5R9IXc0AYGzPQxW9IDRius=:jvlOjZ1AshL6V3AXO5k4HqrtgiukMnMUhV8N3WC3yfY=';
CREATE ROLE muhmah;
ALTER ROLE muhmah WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:G5MMk0gg1vCj0zMjwR0qUw==$9ujh/YgkENwn1mWaSben6vyjOXYM5CiWkK8NolH15Qk=:kUKzVkFj2N+ClVqOmMGz7XSpIxsDoBScsG21bFidZCM=';
CREATE ROLE newuser;
ALTER ROLE newuser WITH NOSUPERUSER INHERIT NOCREATEROLE CREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:j6WuDOTDMEZhy3zj7+IHMA==$Z97oSeFWAKrdsKgAFpRYFwXsSBZCy8VrVkQBVMsccio=:XyhnEjzK5UVYGZ0sGX0OKvb64o4hXHOUKFVR/CkWvUg=';
CREATE ROLE postgres;
ALTER ROLE postgres WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Prkb3A0nGM7gzJIqXaENcg==$Q5aPqBTvmeZJ92+d5Ohq2m7qbUrdqfVbd9LEkK/T2wI=:F2mF26Wti6cLDjAmCqTkpiSU+APRkxtkjEnAovjqusM=';
